//
//  Emitter Animator.swift
//  TinkoffChat
//
//  Created by Jamshid Ruziev on 11/27/17.
...
class Emitter {
    ...
    private func setUpEmitterCell() {
        ...
        emitterConfig.cell.velocityRange = 400.0
        
        emitterConfig.cell.scale = 0.7
        emitterConfig.cell.scaleSpeed = -0.2
        ...
        emitterConfig.cell.birthRate = 10.0
        emitterConfig.cell.xAcceleration = 0.0
        emitterConfig.cell.yAcceleration = 500.0
    }
